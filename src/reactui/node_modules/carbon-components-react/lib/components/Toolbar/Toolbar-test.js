...
describe('[Deprecated] Toolbar', function () {
  var Toolbar;
  var ToolbarItem;
  var ToolbarTitle;
  var ToolbarOption;
  ...
  describe('renders as expected', function () {
    describe('toolbar container', function () {
      it('should render the expected classes', function () {
        var toolbar = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(Toolbar, {
  ...
  describe('Toolbar Search Item', function () {
    ...
    var expandBtn;
    beforeEach(function () {
      toolbar = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(Toolbar, {
        className: "extra-class"
      }, /*#__PURE__*/_react.default.createElement(ToolbarItem, {
        type: "search"
      })));
      toolbarSearch = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(ToolbarSearch, {
    ...
    it('should minimize the search when clicking outside of the search item', function () {
      var rootWrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(ToolbarSearch, null));
  ...
  describe('ToolbarItem with an overflow menu', function () {
    var toolbarItem;
    beforeEach(function () {
      toolbarItem = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(ToolbarItem, null, /*#__PURE__*/_react.default.createElement(_OverflowMenu.default, null)));
    });
    ...
    describe('with ToolbarTitle ', function () {
      var withToolbarTitle;
      var toolbarTitle;
      beforeEach(function () {
        withToolbarTitle = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(ToolbarItem, null, /*#__PURE__*/_react.default.createElement(_OverflowMenu.default, {
          open: true
        }, /*#__PURE__*/_react.default.createElement(ToolbarTitle, {
          title: "Test title"
        }))));
    ...
    describe('with ToolbarOption ', function () {
      var withToolbarOption;
      var toolbarOption;
      beforeEach(function () {
        withToolbarOption = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(ToolbarItem, null, /*#__PURE__*/_react.default.createElement(_OverflowMenu.default, {
          open: true
        }, /*#__PURE__*/_react.default.createElement(ToolbarOption, null, /*#__PURE__*/_react.default.createElement("div", null, "Test child")))));
    ...
    describe('with ToolbarDivider ', function () {
      var withToolbarDivider;
      var toolbarDivider;
      beforeEach(function () {
        withToolbarDivider = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(ToolbarItem, null, /*#__PURE__*/_react.default.createElement(_OverflowMenu.default, {
          open: true
        }, /*#__PURE__*/_react.default.createElement(ToolbarDivider, null))));
