  ...
  _createClass(Tooltip, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          other = _objectWithoutProperties(_this$props, ["triggerId", "tooltipBodyId", "children", "className", "triggerClassName", "direction", "align", "focusTrap", "triggerText", "showIcon", "iconName", "iconDescription", "renderIcon", "menuOffset", "tabIndex", "innerRef", "selectorPrimaryFocus"]);

      var _ref4 = this.isControlled ? this.props : this.state,
          open = _ref4.open;

      var tooltipClasses = (0, _classnames.default)("".concat(prefix, "--tooltip"), (_classNames = {}, _defineProperty(_classNames, "".concat(prefix, "--tooltip--shown"), open), _defineProperty(_classNames, "".concat(prefix, "--tooltip--").concat(direction), direction), _defineProperty(_classNames, "".concat(prefix, "--tooltip--align-").concat(align), align), _classNames), className);
