...
var Modal = /*#__PURE__*/function (_Component) {
  ...
  function Modal() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleMousedown", function (evt) {
      if (_this.innerModal.current && !_this.innerModal.current.contains(evt.target) && !(0, _wrapFocus.elementOrParentIsFloatingMenu)(evt.target, _this.props.selectorsFloatingMenus) && !_this.props.preventCloseOnClickOutside) {
        _this.props.onRequestClose(evt);
      }
    });
  ...
  _createClass(Modal, [{
    ...
    value: function render() {
      ...
      var modalBody = /*#__PURE__*/_react.default.createElement("div", _extends({
        ref: this.innerModal,
        role: "dialog"
      }, alertDialogProps, {
...
}, _defineProperty(_defineProperty2, 'aria-label', (0, _requiredIfGivenPropIsTruthy.default)('hasScrollingContent', _propTypes.default.string)), _defineProperty(_defineProperty2, "children", _propTypes.default.node), _defineProperty(_defineProperty2, "className", _propTypes.default.string), _defineProperty(_defineProperty2, "danger", _propTypes.default.bool), _defineProperty(_defineProperty2, "focusTrap", (0, _deprecate.default)(_propTypes.default.bool, "\nThe prop `focusTrap` for Modal has been deprecated, as the feature of `focusTrap` runs by default.")), _defineProperty(_defineProperty2, "hasForm", _propTypes.default.bool), _defineProperty(_defineProperty2, "hasScrollingContent", _propTypes.default.bool), _defineProperty(_defineProperty2, "iconDescription", _propTypes.default.string), _defineProperty(_defineProperty2, "id", _propTypes.default.string), _defineProperty(_defineProperty2, "modalAriaLabel", _propTypes.default.string), _defineProperty(_defineProperty2, "modalHeading", _propTypes.default.node), _defineProperty(_defineProperty2, "modalLabel", _propTypes.default.node), _defineProperty(_defineProperty2, "onKeyDown", _propTypes.default.func), _defineProperty(_defineProperty2, "onRequestClose", _propTypes.default.func), _defineProperty(_defineProperty2, "onRequestSubmit", _propTypes.default.func), _defineProperty(_defineProperty2, "onSecondarySubmit", _propTypes.default.func), _defineProperty(_defineProperty2, "open", _propTypes.default.bool), _defineProperty(_defineProperty2, "passiveModal", _propTypes.default.bool), _defineProperty(_defineProperty2, "preventCloseOnClickOutside", _propTypes.default.bool), _defineProperty(_defineProperty2, "primaryButtonDisabled", _propTypes.default.bool), _defineProperty(_defineProperty2, "primaryButtonText", _propTypes.default.node), _defineProperty(_defineProperty2, "secondaryButtonText", _propTypes.default.node), _defineProperty(_defineProperty2, "selectorPrimaryFocus", _propTypes.default.string), _defineProperty(_defineProperty2, "selectorsFloatingMenus", _propTypes.default.arrayOf(_propTypes.default.string)), _defineProperty(_defineProperty2, "shouldSubmitOnEnter", _propTypes.default.bool), _defineProperty(_defineProperty2, "size", _propTypes.default.oneOf(['xs', 'sm', 'lg'])), _defineProperty2));
