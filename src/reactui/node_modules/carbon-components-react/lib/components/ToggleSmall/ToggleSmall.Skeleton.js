...
_defineProperty(ToggleSmallSkeleton, "propTypes", (_defineProperty2 = {}, _defineProperty(_defineProperty2, 'aria-label', _propTypes.default.string.isRequired), _defineProperty(_defineProperty2, "className", _propTypes.default.string), _defineProperty(_defineProperty2, "id", _propTypes.default.string), _defineProperty(_defineProperty2, "labelText", _propTypes.default.string), _defineProperty2));
