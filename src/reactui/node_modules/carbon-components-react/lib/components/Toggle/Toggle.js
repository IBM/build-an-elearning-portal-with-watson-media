...
_defineProperty(Toggle, "propTypes", (_defineProperty2 = {}, _defineProperty(_defineProperty2, 'aria-label', _propTypes.default.string.isRequired), _defineProperty(_defineProperty2, "className", _propTypes.default.string), _defineProperty(_defineProperty2, "defaultToggled", _propTypes.default.bool), _defineProperty(_defineProperty2, "id", _propTypes.default.string.isRequired), _defineProperty(_defineProperty2, "labelA", _propTypes.default.node.isRequired), _defineProperty(_defineProperty2, "labelB", _propTypes.default.node.isRequired), _defineProperty(_defineProperty2, "labelText", _propTypes.default.node), _defineProperty(_defineProperty2, "onChange", _propTypes.default.func), _defineProperty(_defineProperty2, "onToggle", _propTypes.default.func), _defineProperty(_defineProperty2, "toggled", _propTypes.default.bool), _defineProperty2));
