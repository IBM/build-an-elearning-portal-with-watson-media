...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-e1x2d7hq0dk">Show
  modal</button>

<div data-modal id="modal-e1x2d7hq0dk" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-e1x2d7hq0dk-label" aria-describedby="modal-e1x2d7hq0dk-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-e1x2d7hq0dk-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-e1x2d7hq0dk-heading">Modal heading</p>
