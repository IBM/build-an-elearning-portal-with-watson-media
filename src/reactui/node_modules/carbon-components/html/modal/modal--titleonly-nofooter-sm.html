...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-v87yfvzk959">Show
  modal</button>

<div data-modal id="modal-v87yfvzk959" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-v87yfvzk959-label" aria-describedby="modal-v87yfvzk959-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-v87yfvzk959-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-v87yfvzk959-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
