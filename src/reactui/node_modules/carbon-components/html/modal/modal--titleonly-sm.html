...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-r5x1dova2s">Show
  modal</button>

<div data-modal id="modal-r5x1dova2s" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-r5x1dova2s-label" aria-describedby="modal-r5x1dova2s-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-r5x1dova2s-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-r5x1dova2s-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
