...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-mnnntvt5v9b">Show
  modal</button>

<div data-modal id="modal-mnnntvt5v9b" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-mnnntvt5v9b-label" aria-describedby="modal-mnnntvt5v9b-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-mnnntvt5v9b-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-mnnntvt5v9b-heading">Modal heading</p>
