...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-c6xl05ahlls">Show
  modal</button>

<div data-modal id="modal-c6xl05ahlls" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-c6xl05ahlls-label" aria-describedby="modal-c6xl05ahlls-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-c6xl05ahlls-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-c6xl05ahlls-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
