...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-c62br3vyit">Show
  modal</button>

<div data-modal id="modal-c62br3vyit" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-c62br3vyit-label" aria-describedby="modal-c62br3vyit-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-c62br3vyit-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-c62br3vyit-heading">Modal heading</p>
