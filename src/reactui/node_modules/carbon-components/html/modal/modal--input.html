...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-nw06v19606r">Show
  modal</button>

<div data-modal id="modal-nw06v19606r" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-nw06v19606r-label" aria-describedby="modal-nw06v19606r-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-nw06v19606r-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-nw06v19606r-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-nw06v19606r" class="bx--label">Text Input label</label>
        <input id="text-input-nw06v19606r" type="text" class="bx--text-input" placeholder="Optional placeholder text"
