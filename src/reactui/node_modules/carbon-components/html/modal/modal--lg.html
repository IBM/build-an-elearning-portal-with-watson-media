...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-692ghayi24p">Show
  modal</button>

<div data-modal id="modal-692ghayi24p" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-692ghayi24p-label" aria-describedby="modal-692ghayi24p-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-692ghayi24p-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-692ghayi24p-heading">Modal heading</p>
