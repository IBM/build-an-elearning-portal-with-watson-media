...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-rn01dpu0umj">Show
  modal</button>

<div data-modal id="modal-rn01dpu0umj" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-rn01dpu0umj-label" aria-describedby="modal-rn01dpu0umj-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-rn01dpu0umj-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-rn01dpu0umj-heading">Modal heading</p>
