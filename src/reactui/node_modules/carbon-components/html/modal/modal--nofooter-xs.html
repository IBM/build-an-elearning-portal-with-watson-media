...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-gdx6x0i2rl5">Show
  modal</button>

<div data-modal id="modal-gdx6x0i2rl5" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-gdx6x0i2rl5-label" aria-describedby="modal-gdx6x0i2rl5-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-gdx6x0i2rl5-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-gdx6x0i2rl5-heading">Modal heading</p>
