...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-prp1f3cf0p">Show
  modal</button>

<div data-modal id="modal-prp1f3cf0p" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-prp1f3cf0p-label" aria-describedby="modal-prp1f3cf0p-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-prp1f3cf0p-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-prp1f3cf0p-heading">Modal heading</p>
